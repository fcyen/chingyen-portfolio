...
- **Content**: bespoke React components per case study under `routes/projects/` (no MDX runtime)
...
src/
  ...
  routes/
    ...
    Work/WorkPost.tsx      # slug → project component dispatcher (rendered for /work/:slug)
  ...
  data/
    ...
    substack.d.ts          # ambient module declaration for the generated JSON
    instagram-posts.json   # static feed for the crafter RightCard tile grid
  lib/
