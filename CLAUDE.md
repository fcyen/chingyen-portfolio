...
src/
  ...
  data/
    posts.ts | posts/*.mdx
    substack.json          # generated by scripts/fetch-substack.mjs at build time (npm `prebuild`)
    instagram-posts.json   # static Instagram post metadata for Explorer feed
  lib/
...
npm run build        # tsc -b && vite build; `prebuild` runs scripts/fetch-substack.mjs first
