...
src/
  ...
  data/
    ...
    substack.d.ts          # type ambient for the substack JSON import
    instagram-posts.json   # static feed data
  lib/
...
npm run build        # prebuild (scripts/fetch-substack.mjs) → tsc -b && vite build
